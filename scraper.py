...
class AmazonScraper:
    ...
    def _parse(self, html: str, domain: str) -> list[Product]:
        ...
        # Cuando lo visitas desde Japón, te puede mostrar JPY, etc.
    ...
    def _detect_page_currency(self, soup, default: str) -> str:
        ...
        """
        # Revisar los primeros símbolos de precio que encontremos
        ...
        for sym in symbols:
            ...
            if "EUR" in text or "€" in text:
                return "EUR"
            if "JPY" in text or "¥" in text or "￥" in text:
                return "JPY"
    ...
    def _detect_currency_from_text(self, text: str, default: str) -> str:
        ...
        if "EUR" in text_upper or "€" in text:
            return "EUR"
        if "JPY" in text_upper or "¥" in text or "￥" in text:
            return "JPY"
